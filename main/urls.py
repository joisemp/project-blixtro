...
from core.views import LandingPageView, OrgDetailView, DepartmentCreateView, DeptIncargeCreateView, OrgPeopleListView, GenerateReportView
...
urlpatterns = [
    ...
    path('org/<int:org_id>/generate-report/', GenerateReportView.as_view(), name='generate-report'),
    path('org/<int:org_id>/people/', OrgPeopleListView.as_view(), name='org-people-list'),
